...
const ListPopup: React.FC = () => {
  ...
  return (
    <div className="fixed top-16 right-10 z-50 w-80 rounded-2xl border border-gray-200 bg-white p-4 shadow-lg">
      {/* Header */}
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-2xl">Your List</h2>
      </div>
